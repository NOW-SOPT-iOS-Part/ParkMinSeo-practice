...
extension ChatModel {
    static func dummy() -> [ChatModel] {
        return [
            ...
            ChatModel(profileImg: .profile6, name: "김민서", place: "중국", message: "뿡", itemImg: .product6),
            ChatModel(profileImg: .profile1, name: "김수연", place: "일본", message: "자기야 미안해 했자나", itemImg: .product7),
            ChatModel(profileImg: .profile2, name: "한지석", place: "태국", message: "솝트 이딴거 안했어", itemImg: .product8),
            ChatModel(profileImg: .profile3, name: "한정원", place: "명왕성", message: "진짜?", itemImg: .product9),
            ChatModel(profileImg: .profile4, name: "이지훈", place: "안드로메다", message: "난이서~", itemImg: .product10)
        ]
    }
}
